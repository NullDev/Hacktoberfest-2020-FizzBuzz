...
/*
 * SUM OF KATA : 1 - We have from 1 to 100 like entry point 2- If number is in
 * range of 0 to 2 returns the number name on string format 2 - If Number is
 * divisible by 3 returns FIZZ 3. If number is divisible by 5 returns BUZZ 4. If
